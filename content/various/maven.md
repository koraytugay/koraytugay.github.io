...
## Resource Filtering
Maven can replace variables on arbitrary resource files during a build, given it is configured. See [Apache Maven Resources Plugin's Filter Goal](https://maven.apache.org/plugins/maven-resources-plugin/examples/filter.html) to get started. Here is an example, given the following layout:
